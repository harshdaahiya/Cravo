        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-background">
            <div className="text-center">
                ...
                <div className="relative mx-auto mb-8 h-40 w-80">
                    {/* Road */}
                    <div className="absolute bottom-0 h-2 w-full rounded bg-muted">
                        <div className="road-lines absolute top-1/2 h-0.5 w-full -translate-y-1/2 transform bg-background"></div>
                    </div>
                    ...
                    <div className="delivery-scooter absolute bottom-2 left-0 h-16 w-24">
                        ...
                        <div className="rider absolute -top-8 left-4">
                            ...
                            {/* Body */}
                            <div className="relative mx-auto h-6 w-3 rounded bg-info">
                                {/* Arms */}
                            ...
                            <div className="mt-1 flex justify-center space-x-1">
                                <div className="h-4 w-1 rounded bg-info"></div>
                                <div className="h-4 w-1 rounded bg-info"></div>
                            </div>
                        </div>

                        {/* Scooter Body */}
                        <div className="absolute bottom-0 left-2 h-6 w-16 rounded-lg bg-destructive">
                            <div className="absolute top-1 left-1 h-2 w-3 rounded bg-destructive"></div>
                            <div className="absolute top-1 right-1 h-2 w-8 rounded bg-destructive"></div>
                        </div>

                        {/* Delivery Box */}
                        <div className="bg-primary absolute -top-2 right-0 h-6 w-6 rounded border-2 border-ring">
                            <div className="bg-primary absolute top-1 left-1 h-1 w-4"></div>
                            <div className="bg-primary absolute top-3 left-1 h-1 w-4"></div>
                        </div>

                        {/* Wheels */}
                        <div className="wheel-front absolute bottom-0 left-1 h-4 w-4 rounded-full bg-black">
                            <div className="absolute top-1 left-1 h-2 w-2 rounded-full bg-muted"></div>
                        </div>
                    ...
                    <div className="speed-lines absolute top-8 left-0">
                        <div className="mb-2 h-0.5 w-8 bg-muted opacity-60"></div>
                        <div className="mb-2 h-0.5 w-6 bg-muted opacity-40"></div>
                        <div className="h-0.5 w-10 bg-muted opacity-80"></div>
                    </div>
                </div>

                {/* Loading Text */}
                <div className="text-center">
                    <h2 className="text-foreground mb-2 text-2xl font-bold">Cravo</h2>
