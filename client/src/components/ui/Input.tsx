...
const Input: React.FC<InputProps> = ({
    ...
    block w-full py-3 border border-cream rounded-lg focus:ring-1 focus:ring-ring text-charcoal placeholder-medium-gray
    transition-all duration-200
    ${iconLeft ? 'pl-10' : 'pl-3'}
    ${iconRight ? 'pr-10' : 'pr-3'}
    ${error ? 'border-destructive-muted focus:ring-destructive' : ''}
  `.trim();
