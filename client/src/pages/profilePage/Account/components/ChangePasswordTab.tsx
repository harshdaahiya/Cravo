        ...
        <div className="space-y-6">
                    ...
                    <div key={field.key}>
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full rounded-xl border border-border px-4 py-3 pr-12 focus:border-transparent focus:ring-2 focus:ring-ring focus:outline-none"
                            />
                            <button
                                onClick={() => toggleVisibility(field.key as keyof typeof showPassword)}
                                className="text-muted-foreground hover:text-muted-foreground absolute top-1/2 right-4 -translate-y-1/2"
                            >
            ...
            <div className="rounded-xl bg-muted p-4">
                ...
                <ul className="text-muted-foreground space-y-1 text-sm">
                    <li className={passwords.new.length >= 8 ? 'text-success' : ''}>
                        • At least 8 characters long
                    </li>
                    <li className={/[A-Z]/.test(passwords.new) ? 'text-success' : ''}>
                        • Contains at least one uppercase letter
                    </li>
                    <li className={/[0-9]/.test(passwords.new) ? 'text-success' : ''}>
            ...
            <div className="flex justify-end pt-4">
                <button
                    ...
                    className="bg-primary hover:bg-primary-hover disabled:bg-muted rounded-xl px-8 py-3 font-bold text-white transition-colors disabled:cursor-not-allowed"
                >
                    Update Password
                </button>
            </div>
