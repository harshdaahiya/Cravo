...
const Payments: React.FC = () => {
    ...
    const cardBrands: Record<string, { name: string; color: string }> = {
        visa: { name: 'Visa', color: 'bg-info' },
        mastercard: { name: 'Mastercard', color: 'bg-destructive' },
        amex: { name: 'American Express', color: 'bg-success' },
    ...
    const getStatusColor = (status: Transaction['status']) => {
        switch (status) {
            case 'completed':
                return 'text-success-foreground bg-success-muted';
            case 'pending':
                return 'text-primary-hover bg-warning-muted';
            case 'refunded':
    ...
    const PaymentMethodsTab = () => (
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <h2 className="text-foreground text-2xl font-bold">Payment Methods</h2>
                <button
                ...
                <div className="border-border rounded-2xl border bg-background p-6 shadow-lg">
                    <div className="mb-6 flex items-center justify-between">
                        ...
                        <div className="flex gap-2">
                            <button
                                ...
                                className="bg-success flex items-center gap-2 rounded-lg px-4 py-2 text-white transition-colors hover:bg-success"
                            >
                    ...
                    <div className="space-y-4">
                        <div className="grid gap-4 md:grid-cols-2">
                            <div>
                                <label className="text-foreground mb-1 block text-sm font-semibold">Card Holder Name</label>
                                <input
                                    type="text"
                            ...
                            <div>
                                <label className="text-foreground mb-1 block text-sm font-semibold">Card Number</label>
                                <input
                                    type="text"
                        ...
                        <div className="grid gap-4 grid-cols-3">
                            <div>
                                <label className="text-foreground mb-1 block text-sm font-semibold">Expiry Month</label>
                                <input
                                    type="text"
                            ...
                            <div>
                                <label className="text-foreground mb-1 block text-sm font-semibold">Expiry Year</label>
                                <input
                                    type="text"
                            ...
                            <div>
                                <label className="text-foreground mb-1 block text-sm font-semibold">CVV</label>
                                <input
                                    type="text"
                                    value={cardForm.cvv}
                        ...
                        <div>
                            <label className="text-foreground mb-1 block text-sm font-semibold">Nickname</label>
                            <input
                                type="text"
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            />
                            <label htmlFor="isDefault" className="text-foreground text-sm font-medium">Set as default payment method</label>
                        </div>
                    </div>
                </div>
            )}
            ...
            <div className="space-y-4">
                {paymentMethods.map(m => (
                    <div
                        key={m.id}
                        className={`rounded-2xl border bg-background p-6 shadow-lg transition-all hover:shadow-xl ${m.isDefault ? 'border-ring bg-warning-muted' : 'border-border'
                            }`}
                    >
                        <div className="flex items-center justify-between">
                            {/* Icon & details */}
                            ...
                            <div className="flex items-center gap-2">
                                {m.type === 'credit' && (
                                    <button
                                        ...
                                        className="text-muted-foreground rounded-lg p-2 transition-colors hover:bg-muted"
                                    >
                                        {showCardNumber[m.id] ? (
                                ...
                                {!m.isDefault && (
                                    <button
                                        ...
                                        className="rounded-lg px-3 py-2 text-sm text-primary-hover transition-colors hover:bg-warning-muted hover:text-warning-foreground"
                                    >
                                        Set Default
                                    </button>
                                )}
                                ...
                                <button
                                    ...
                                    className="text-success rounded-lg p-2 transition-colors hover:bg-success-muted hover:text-success-foreground"
                                >
                                ...
                                <button
                                    ...
                                    className="rounded-lg p-2 text-destructive transition-colors hover:bg-destructive-muted hover:text-destructive"
                                >
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="relative">
                    ...
                    <select
                        ...
                        className="border-border rounded-lg border bg-background py-3 pr-8 pl-10 focus:ring-2 focus:ring-ring"
                    >
            ...
            <div className="space-y-4">
                {filteredTransactions.map(t => (
                    <div
                        key={t.id}
                        className="border-border rounded-2xl border bg-background p-6 shadow-lg transition-all hover:shadow-xl"
                    >
                        <div className="flex items-start justify-between">
                            ...
                            <div className="text-right">
                                ...
                                <button className="mt-2 flex items-center gap-1 rounded-lg px-3 py-1 text-sm text-primary-hover transition-colors hover:bg-warning-muted hover:text-warning-foreground">
                ...
                {filteredTransactions.length === 0 && (
                    <div className="border-border rounded-2xl border bg-background p-12 text-center shadow-lg">
                        <Icon
                            name={'receipt'}
    ...
    const BillingTab = () => (
        <div className="space-y-6">
            ...
            <div className="border-border flex items-start gap-6 rounded-2xl border bg-background p-6 shadow-lg">
                <Icon
                    name={'shield'}
                ...
                <div className="flex-1">
                    <h3 className="text-foreground mb-1 font-semibold">Secure Payments</h3>
                    <p className="text-muted-foreground text-sm">
            ...
            <div className="border-border rounded-2xl border bg-background p-6 shadow-lg">
                <h3 className="text-foreground mb-4 font-semibold">Next Payment</h3>
                <div className="flex items-center justify-between">
